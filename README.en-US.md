...
- `SUBCPU.ROM`  
  ROM for the sub CPU.
- `FONT.ROM`  
  Font ROM for display output. If this file is not present, the emulator uses its built-in initial values, but using a generated file is recommended for correct display behavior.
